...
/* harmony import */ var _modules_modals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modals */ "./src/js/modules/modals.js");
 ...
 // Execute scripts after the DOM structure is ready
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        close = document.querySelector(closeSelector); // Add event listeners to each trigger element
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ''; // Remove Bootstrap class (if applicable)
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // Show the modal window after 60 seconds on the page
